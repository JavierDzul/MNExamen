...
export const SystemMethodJacobi = ( {method, params, setParams}) => {
  ...
  const handleChange = (e) => {
    ...
    console.log(handleParams.x1)
    console.log(handleParams.x2)
    console.log(handleParams.x3)
    ...
    <>
      ...
      <div className=' container-fluid '>
        ...
        <div className="row">
          <div className=' input-group mb-3'>
            <span className=' input-group-text '>x1</span>
            <input className=' form-control' id={'x1'} type="text" value={handleParams['x1']?.toString() || ""} onChange={handleChange} />
          </div>
          ...
          <div className=' input-group mb-3'>
            <span className=' input-group-text '>x2</span>
            <input className=' form-control' id={'x2'} type="text" value={handleParams['x2']?.toString() || ""} onChange={handleChange} />
          </div>
          ...
          <div className=' input-group mb-3'>
            <span className=' input-group-text '>x3</span>
            <input className=' form-control' id={'x3'} type="text" value={handleParams['x3']?.toString() || ""} onChange={handleChange} />
          </div>
        </div>
...
export default SystemMethodJacobi